<template>
	<div>
		<UButton label="Medplum" to="/auth/medplum" :external="true" block color="neutral">
			<template v-slot:leading>
				<div class="h-6 px-2">
					<svg xmlns="http://www.w3.org/2000/svg" height="" viewBox="0 0 50.8 50.8" baseProfile="tiny-ps" version="1.2">
						<title>Medplum</title>
