...
export interface OAuthKeycloakConfig {
   ...
   * @default process.env.FHIR_OAUTH_KEYCLOAK_CLIENT_ID
   */
  clientId?: string
  /**
   * Keycloak OAuth Client Secret
   * @default process.env.FHIR_OAUTH_KEYCLOAK_CLIENT_SECRET
   */
  clientSecret?: string
  /**
   * Keycloak OAuth Server URL
   * @example http://192.168.1.10:8080/auth
   * @default process.env.FHIR_OAUTH_KEYCLOAK_SERVER_URL
   */
  serverUrl?: string
  /**
   * Keycloak OAuth Realm
   * @default process.env.FHIR_OAUTH_KEYCLOAK_REALM
   */
  realm?: string
  /**
